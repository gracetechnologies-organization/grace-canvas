        ...
        <div class="row resume-card-section row1">
            ...
            {{--  @dd($SingleIndex)  --}}
                <div class="mb-3 col-lg-4 col-md-6 col-sm-12">
                    <div class="card">
                        <img src="{{ asset('storage/images/resumes/'.$SingleIndex->front_image) }}" loading="lazy"
                            class="p-3 img-fluid" alt="">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-12 col-md-6 col-sm-3 left-side">
                ...
                <button class="custom-button-css"><a href="{{ route('templates.resume') }}"> Select Templete </a></button><br><br>
            </div>
        </div>
    </div>
</section>
                    ...
                    <div class="card">
                        <div class="card1">
                            ...
                            <div class="card-body">
                                ...
                                <h5 class="text-center para-start">UI/UX Designer <i class="bi bi-star"></i><i
                                        class="bi bi-star"></i><i class="bi bi-star"></i><i class="bi bi-star"></i></h5>
                                <p>
