                                    ...
                                    <form action="{{ route('profile.update') }}" method="POST">
                                        ...
                                        <div class="mt-3 mb-3">
                                            ...
                                            <input id="name" name="name" type="text" class="form-control"
                                                autocomplete="name">
                                            <error :messages="$errors - > updatePassword - > get('name')"
                                                class="mt-2" />
                                        </div>
                                        <div class="">
                                            <button type="submit" class="float-end custom-button-css me-2">Save
                                                Profile</button>
                                        </div>
                                    </form>
                                    <!-- /Account -->
                            ...
                            <div class="col-lg-9 col-sm-12">
                                <div class="p-3 mb-4 card custome-card-border">
                                    ...
                                    <form action="{{ route('password.update') }}" method="POST">
                                        ...
                                        <div class="mt-2">
                                            <button type="submit" class="custom-button-css me-2 float-end">Save
                                                changes</button>
                                        </div>
                                    </form>
                                    <!-- /Account -->
