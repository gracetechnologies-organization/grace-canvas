        ...
        <div class="form-container">
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="my-2 mb-2">
                    ...
                    <input type="email" name="email" id="email" class="form-control mt-2 mb-2"
                ...
                <button type="submit" class="custom-login-signup-css "><a class="nav-link"
                        href="{{ route('register') }}"> Register </a></button>
                        <button type="submit" class="custom-login-signup-css ">Login</button>
            </form>
        </div>
    </div>
</x-guest-layout>
