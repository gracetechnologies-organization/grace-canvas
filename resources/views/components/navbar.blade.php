...
<nav class="navbar navbar-expand-lg navbar-light" id="navbarManu">
    <div class="container">
        <a class="navbar-brand text-light" href="{{ route('home') }}">{{ GoogleTranslate::trans('Grace Canvas ', app()->getLocale()) }}</a>
        ...
        <div class="mb-4 collapse navbar-collapse text-light" id="navbar-supported-content">
            <ul class="mt-4 navbar-nav ms-auto custom-navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('templates.resume') }}">{{ GoogleTranslate::trans('Resume Templates', app()->getLocale()) }}</a>
                </li>
                {{-- <li class="nav-item">
